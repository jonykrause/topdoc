...
(function() {
  ...
  var Topdocument, cssParse, fs, path, read, yaml, topdocutils, CleanCSS;
  ...
  Topdocument = (function() {
    ...
    Topdocument.prototype.topdocParse = function() {
      ...
      for (i = _i = 0, _len = rules.length; _i < _len; i = ++_i) {
        ...
        if (this.isValidComment(listItem)) {
          ...
          component = yaml.safeLoad(listItem.comment);
          component.code = component.code || {};
          component.css = css;
          component.code.css = css;
          component.markup = this.parseMarkup(listItem.comment);
          component.code = highlight(component.code);
    ...
    Topdocument.prototype.parseMarkup = function(comment) {
      var commentEnd, indent;
      var markup = comment;
      var indexOfHTML = markup.search(/html:/);
      // Return empty string if html is not present
      if (indexOfHTML === -1) return '';
      markup = markup.substring(indexOfHTML+7);
      ...
      markup = markup.trim();
      // Convention: Trim quotes at start and end
      markup = markup.substring(1, markup.length - 1);
      return markup;
    };
