  ...
  Topdoc = (function() {
    ...
    Topdoc.prototype.findCSSFiles = function(dir) {
      ...
      for (_i = 0, _len = list.length; _i < _len; _i++) {
        ...
        } else if (this.getExtension(file) === 'css' && file.lastIndexOf('.min.css') !== file.length - 8 || this.getExtension(file) === 'scss') {
          results.push(file);
        }
      }
      return results;
    ...
    Topdoc.prototype.outputUrlify = function(inputURL) {
      var url;
      var ext = this.getExtension(inputURL);
      url = inputURL.substring(0, inputURL.length - ext.length - 1);
      url = url + '.html';
      return url;
    };
